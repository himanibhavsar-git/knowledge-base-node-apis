...
export class Failure extends Error {
  ...
  constructor(title: string, description: string, errStack?: Json, isError?: boolean, data?: any) {
    super(title);
    this.title = title;
...
export class SpFailure extends Failure {
  constructor(title: string, description: string, isSpError: boolean, data?: Json) {
